...
//                   children: [
//                     Iconbuttons(
//                       icon: likes.value.contains(currentuserdata!.uid)
//                           ? const Icon(
//                               kfavorite,
//                               size: 29,
//                               color: kRed,
...
//                                 savepost.value.remove(data['postId']);
//                                 issave.value = false;
//                                 savepost
...
//                               } else {
//                                 issave.value = true;
//                                 savepost.value.add(data['postId']);
//                                 savepost
//                                     // ignore: invalid_use_of_protected_member, invalid_use_of_visible_for_testing_member
//                                     .notifyListeners();
//                               }
...
//                               ? const Center(
//                                   child: Text('No Likes for this post'))
...
//                     commentLength.value = snapshot.data!.docs.length;
